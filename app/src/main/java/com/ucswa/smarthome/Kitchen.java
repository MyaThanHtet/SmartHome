...
public class Kitchen extends AppCompatActivity {
    ...
    DatabaseReference savedPhone;
    private ConstraintLayout cst;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.kitchen_layout);
        fire_detectTv = findViewById(R.id.fire_detectTv);
        Emergency_Call_btn = findViewById(R.id.fire_emergency);
        lampImg = findViewById(R.id.imgLamp_kitchen);
        toggle = findViewById(R.id.Onbtn_kitchen);
        save_Btn = findViewById(R.id.ph_no_save_btn);
        phone = findViewById(R.id.phone_text);
        cst = findViewById(R.id.fire_layout);
        fireAlarmSwitch = findViewById(R.id.fire_alarm_switch);
        ...
        final DatabaseReference led = myRef.child("led_status_kitchen");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    String str = (String) dataSnapshot.child("led_status_kitchen").getValue();
        ...
        try {
            if (Build.VERSION.SDK_INT > 22) {
                if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Kitchen.this, new String[]{Manifest.permission.CALL_PHONE}, 101);
                    return;
                }
    ...
    public void savePhone(View v) {
        Toast.makeText(Kitchen.this, "Hello", Toast.LENGTH_SHORT).show();

        savedPhone.setValue(Objects.requireNonNull(phone.getText()).toString());
