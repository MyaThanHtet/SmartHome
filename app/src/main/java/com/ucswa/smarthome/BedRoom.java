...
public class BedRoom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lampImg = findViewById(R.id.imgLamp_bedroom);
...
//        final ArcProgress arcProgressHum = findViewById(R.id.hum_arc_progress);
        ...
        final DatabaseReference led = myRef.child("led_status_bedroom");
        toggle = findViewById(R.id.Onbtn_bedroom);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    float temperature = dataSnapshot.child("temp_for_bedroom").getValue(float.class);
                    float humidity = dataSnapshot.child("hum_for_bedroom").getValue(float.class);
//                    arcProgressTemp.setProgress((int) temperature);
//                    arcProgressHum.setProgress((int) humidity);
                    String str = (String) dataSnapshot.child("led_status_bedroom").getValue();
                    if (str.equals("ON")) {
